...
import AirHero from '@/components/custom/AirHero';
            ...
            <article className="space-y-12 text-gray-700">
              <header>
                ...
                <p className="mt-4 text-sm lg:text-base leading-relaxed max-w-3xl">
                  ...
                  time-critical logistical challenges. By combining the speed of
                  air with the cost savings of other modes, backed by smooth and
                  efficient customs and administrative procedures, customers can
                  enjoy the best of both worlds; reducing inventory and
                  improving their own service offer with faster response times
                  at affordable cost.
                </p>
              </header>
